...
class _LocationRemoteDatasource implements LocationRemoteDatasource {
  ...
  @override
  Future<BaseResponse<UserLocationDto>> getLocation() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BaseResponse<UserLocationDto>>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseResponse<UserLocationDto> _value;
    try {
      _value = BaseResponse<UserLocationDto>.fromJson(
        _result.data!,
        (json) => UserLocationDto.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
